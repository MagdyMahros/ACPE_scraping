...
# MAIN ROUTINE
courses_page_url = 'https://acpe.edu.au/future-students/study/courses/'
site_url = 'https://acpe.edu.au'
list_of_links = []
...
result_elements = soup.find_all('a', attrs={"class": "widget-button tiny-rounded medium custom_style position-after"},
                                href=True)
...
# SAVE TO FILE
course_links_file_path = os.getcwd().replace('\\', '/') + '/ACPE_courses_links.txt'
